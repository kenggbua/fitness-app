...
router.get('/:num', (req, res) => {
  ...
  db.query({
      text: `Select TO_CHAR(f.date, 'dd.mm.yyyy') as date, w.name as workout_name, f.sumweight from public.workout_fin f, public.workout w where f.u_name = $1 and f.workout_id = w.id order by f.date desc limit $2;`,
